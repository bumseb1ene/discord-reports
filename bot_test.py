...
import re
import discord
from nlp_processor import is_player_report
...
class MyBot(commands.Bot):
    ...
    async def find_and_respond_player(self, message, reported_identifier, max_levenshtein_distance=1, jaro_winkler_threshold=0.85):
